...
userspeed=int(input("Pls enter the speed to search, 1:0.2 Mps, 2:10 mps, 3:25Mgps, 4:100Mgps,, 5:250Mgps, 6:1000Mgps "))



def states(state,speed):
    ...
    userState= speedselect[userspeed]
    ...
    #separating by resident and business
    res=coppercol[::2]
    biz=coppercol[1::2]
    #types of conections
    types=["copper"," cable"," fiber"," gso_satellite"," ngso_satellite"," unlicensed_tfw"," licensed_tfw"," other"] #," mobile_voice"," 3g"," 4g"," 5g"]" lbr_tfw",
